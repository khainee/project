...
public class RequestNetworkController {
    ...
    private OkHttpClient getClient() throws NoSuchAlgorithmException, KeyManagementException {
        if (this.client == null) {
            ...
            try {
                TrustManager[] trustManagerArr = {new X509TrustManager() { // from class: com.my.freemyanmarid.RequestNetworkController.1
                ...
                builder.hostnameVerifier(new HostnameVerifier() { // from class: com.my.freemyanmarid.RequestNetworkController.2
    ...
    public void execute(final RequestNetwork requestNetwork, String str, String str2, final String str3, final RequestNetwork.RequestListener requestListener) {
        ...
        try {
            ...
            getClient().newCall(builder.build()).enqueue(new Callback() { // from class: com.my.freemyanmarid.RequestNetworkController.3
                ...
                public void onFailure(Call call, final IOException iOException) {
                    ...
                    activity.runOnUiThread(new Runnable() { // from class: com.my.freemyanmarid.RequestNetworkController.3.1
                ...
                public void onResponse(Call call, final Response response) throws IOException {
                    final String strTrim = response.body().string().trim();
                    Activity activity = requestNetwork.getActivity();
                    final RequestNetwork.RequestListener requestListener2 = requestListener;
                    final String str4 = str3;
                    activity.runOnUiThread(new Runnable() { // from class: com.my.freemyanmarid.RequestNetworkController.3.2
                        @Override // java.lang.Runnable
                        public void run() {
                            Headers headers = response.headers();
                            HashMap<String, Object> map = new HashMap<>();
                            for (String str5 : headers.names()) {
                                map.put(str5, headers.get(str5) != null ? headers.get(str5) : "null");
                            }
                            requestListener2.onResponse(str4, strTrim, map);
                        }
                    });
                }
            });
