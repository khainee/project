...
public class ShapeAppearanceModel {
    ...
    private static Builder builder(Context context, int shapeAppearanceResId, int shapeAppearanceOverlayResId, CornerSize defaultCornerSize) throws Resources.NotFoundException {
