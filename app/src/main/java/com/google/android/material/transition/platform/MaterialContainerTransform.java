...
public final class MaterialContainerTransform extends Transition {
    ...
    public MaterialContainerTransform(Context context, boolean entering) throws NumberFormatException {
        this.drawDebugEnabled = false;
        this.holdAtEndEnabled = false;
        this.pathMotionCustom = false;
        this.appliedThemeValues = false;
    ...
    @Override // android.transition.Transition
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) throws Resources.NotFoundException, NumberFormatException {
        View drawingView;
        View boundingView;
    ...
    private void maybeApplyThemeValues(Context context, boolean entering) throws NumberFormatException {
