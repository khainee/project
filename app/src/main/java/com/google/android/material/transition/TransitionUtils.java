...
class TransitionUtils {
    ...
    static boolean maybeApplyThemeInterpolator(Transition transition, Context context, int attrResId, TimeInterpolator defaultInterpolator) throws NumberFormatException {
    ...
    static View findAncestorById(View view, int ancestorId) throws Resources.NotFoundException {
