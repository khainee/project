...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) throws NoSuchMethodException, SecurityException, ClassNotFoundException, StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        ensureToolbar();
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) throws NoSuchMethodException, SecurityException, ClassNotFoundException, StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
    ...
    private void updateTextBounds(int left, int top, int right, int bottom, boolean forceRecalculate) throws NoSuchMethodException, SecurityException, ClassNotFoundException, StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        View view;
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
