...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public int getShadowOffsetX() {
        ...
        double dSin = Math.sin(Math.toRadians(this.drawableState.shadowCompatRotation));
        Double.isNaN(d);
        return (int) (d * dSin);
    }
    ...
    public int getShadowOffsetY() {
        double d = this.drawableState.shadowCompatOffset;
        double dCos = Math.cos(Math.toRadians(this.drawableState.shadowCompatRotation));
        Double.isNaN(d);
        return (int) (d * dCos);
    }
