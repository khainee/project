...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    boolean setLiftedState(boolean lifted, boolean force) throws Resources.NotFoundException {
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted) throws Resources.NotFoundException {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public boolean onLayoutChild(CoordinatorLayout parent, T abl, int layoutDirection) throws NoSuchFieldException {
            int offset;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.android.material.appbar.HeaderBehavior
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T appBarLayout, int newOffset, int minOffset, int maxOffset) throws NoSuchFieldException {
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout parent, T layout, int offset, int direction, boolean forceJump) throws NoSuchFieldException {
