...
abstract class MaterialVisibility<P extends VisibilityAnimatorProvider> extends Visibility {
    ...
    private Animator createAnimator(ViewGroup sceneRoot, View view, boolean appearing) throws NumberFormatException {
    ...
    private void maybeApplyThemeValues(Context context, boolean appearing) throws NumberFormatException {
