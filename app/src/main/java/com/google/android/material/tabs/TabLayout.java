...
public class TabLayout extends HorizontalScrollView {
    ...
    private void addTabFromItemView(TabItem item) throws Resources.NotFoundException {
        Tab tab = newTab();
        if (item.text != null) {
    ...
    public void removeTabAt(int position) throws Resources.NotFoundException {
        Tab tab = this.selectedTab;
    ...
    public void removeAllTabs() throws Resources.NotFoundException {
    ...
    public void setTabTextColors(ColorStateList textColor) throws Resources.NotFoundException {
    ...
    public void setTabTextColors(int normalColor, int selectedColor) throws Resources.NotFoundException {
        setTabTextColors(createColorStateList(normalColor, selectedColor));
    }

    public void setTabIconTint(ColorStateList iconTint) throws Resources.NotFoundException {
    ...
    public void setTabIconTintResource(int iconTintResourceId) throws Resources.NotFoundException {
    ...
    public void setSelectedTabIndicator(Drawable tabSelectedIndicator) {
        if (this.tabSelectedIndicator != tabSelectedIndicator) {
            ...
            int indicatorHeight = intrinsicHeight;
    ...
    public void setupWithViewPager(ViewPager viewPager, boolean autoRefresh) throws Resources.NotFoundException {
        setupWithViewPager(viewPager, autoRefresh, false);
    }

    private void setupWithViewPager(ViewPager viewPager, boolean autoRefresh, boolean implicitSetup) throws Resources.NotFoundException {
    ...
    @Deprecated
    public void setTabsFromPagerAdapter(PagerAdapter adapter) throws Resources.NotFoundException {
    ...
    void setPagerAdapter(PagerAdapter adapter, boolean addObserver) throws Resources.NotFoundException {
    ...
    void populateFromPagerAdapter() throws Resources.NotFoundException {
        int curItem;
        removeAllTabs();
        PagerAdapter pagerAdapter = this.pagerAdapter;
    ...
    private void updateAllTabs() throws Resources.NotFoundException {
    ...
    private TabView createTabView(Tab tab) throws Resources.NotFoundException {
    ...
    @Override // android.widget.HorizontalScrollView, android.view.ViewGroup
    public void addView(View child) throws Resources.NotFoundException {
        addViewInternal(child);
    }

    @Override // android.widget.HorizontalScrollView, android.view.ViewGroup
    public void addView(View child, int index) throws Resources.NotFoundException {
        addViewInternal(child);
    }

    @Override // android.widget.HorizontalScrollView, android.view.ViewGroup, android.view.ViewManager
    public void addView(View child, ViewGroup.LayoutParams params) throws Resources.NotFoundException {
        addViewInternal(child);
    }
    ...
    private void addViewInternal(View child) throws Resources.NotFoundException {
    ...
    private void removeTabViewAt(int position) throws Resources.NotFoundException {
    ...
    public static class Tab {
        ...
        public Tab setCustomView(View view) throws Resources.NotFoundException {
        ...
        public Tab setIcon(Drawable icon) throws Resources.NotFoundException {
            this.icon = icon;
        ...
        public Tab setText(CharSequence text) throws Resources.NotFoundException {
        ...
        public Tab setTabLabelVisibility(int mode) throws Resources.NotFoundException {
        ...
        public Tab setContentDescription(CharSequence contentDesc) throws Resources.NotFoundException {
        ...
        void updateView() throws Resources.NotFoundException {
            TabView tabView = this.view;
            if (tabView != null) {
                tabView.update();
            }
    ...
    public final class TabView extends LinearLayout {
        ...
        void setTab(Tab tab) throws Resources.NotFoundException {
            if (tab != this.tab) {
                this.tab = tab;
                update();
            }
        ...
        final void update() throws Resources.NotFoundException {
            Tab tab = this.tab;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public BadgeDrawable getOrCreateBadge() throws Resources.NotFoundException {
        ...
        private void addOnLayoutChangeListener(final View view) {
            ...
            view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.google.android.material.tabs.TabLayout.TabView.1
                ...
                public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) throws Resources.NotFoundException {
        ...
        private void tryUpdateBadgeAnchor() throws Resources.NotFoundException {
            Tab tab;
            Tab tab2;
            if (!hasBadgeDrawable()) {
                return;
        ...
        private void tryAttachBadgeToAnchor(View anchorView) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void tryUpdateBadgeDrawableBounds(View anchor) throws Resources.NotFoundException {
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(ViewPager viewPager, PagerAdapter oldAdapter, PagerAdapter newAdapter) throws Resources.NotFoundException {
