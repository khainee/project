...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    void setBadge(BadgeDrawable badgeDrawable) throws Resources.NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void tryUpdateBadgeBounds(View anchorView) throws Resources.NotFoundException {
        if (!hasBadge()) {
            return;
        }
