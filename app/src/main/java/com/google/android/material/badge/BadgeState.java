...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        state.backgroundColor = Integer.valueOf(iIntValue);
        ...
        state.badgeGravity = Integer.valueOf(iIntValue2);
        ...
        state.horizontalOffsetWithoutText = Integer.valueOf(iIntValue3);
        if (storedState.horizontalOffsetWithoutText == null) {
        ...
        state.verticalOffsetWithoutText = Integer.valueOf(iIntValue4);
        if (storedState.horizontalOffsetWithText == null) {
            iIntValue5 = a.getDimensionPixelOffset(R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
            iIntValue5 = storedState.horizontalOffsetWithText.intValue();
        }
        state.horizontalOffsetWithText = Integer.valueOf(iIntValue5);
        if (storedState.verticalOffsetWithText == null) {
            iIntValue6 = a.getDimensionPixelOffset(R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
            iIntValue6 = storedState.verticalOffsetWithText.intValue();
        }
        state.verticalOffsetWithText = Integer.valueOf(iIntValue6);
