...
public final class TabLayoutMediator {
    ...
    public void attach() throws Resources.NotFoundException {
        if (this.attached) {
    ...
    void populateTabsFromPagerAdapter() throws Resources.NotFoundException {
    ...
    private class PagerAdapterObserver extends RecyclerView.AdapterDataObserver {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeChanged(int positionStart, int itemCount) throws Resources.NotFoundException {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeChanged(int positionStart, int itemCount, Object payload) throws Resources.NotFoundException {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeInserted(int positionStart, int itemCount) throws Resources.NotFoundException {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeRemoved(int positionStart, int itemCount) throws Resources.NotFoundException {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) throws Resources.NotFoundException {
            TabLayoutMediator.this.populateTabsFromPagerAdapter();
        }
    }
}
