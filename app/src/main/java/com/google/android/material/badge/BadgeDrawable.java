...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void restoreState() throws Resources.NotFoundException {
    ...
    private BadgeDrawable(Context context, int badgeResId, int defStyleAttr, int defStyleRes, BadgeState.State savedState) throws Resources.NotFoundException {
    ...
    @Deprecated
    public void updateBadgeCoordinates(View anchorView, ViewGroup customBadgeParent) throws Resources.NotFoundException {
    ...
    public void updateBadgeCoordinates(View anchorView) throws Resources.NotFoundException {
        updateBadgeCoordinates(anchorView, (FrameLayout) null);
    }

    public void updateBadgeCoordinates(View anchorView, FrameLayout customBadgeParent) throws Resources.NotFoundException {
    ...
    public void setNumber(int number) throws Resources.NotFoundException {
    ...
    private void onNumberUpdated() throws Resources.NotFoundException {
    ...
    public void setMaxCharacterCount(int maxCharacterCount) throws Resources.NotFoundException {
    ...
    private void onMaxCharacterCountUpdated() throws Resources.NotFoundException {
    ...
    public void setBadgeGravity(int gravity) throws Resources.NotFoundException {
    ...
    private void onBadgeGravityUpdated() throws Resources.NotFoundException {
    ...
    public void setHorizontalOffset(int px) throws Resources.NotFoundException {
    ...
    public void setHorizontalOffsetWithoutText(int px) throws Resources.NotFoundException {
    ...
    public void setHorizontalOffsetWithText(int px) throws Resources.NotFoundException {
    ...
    void setAdditionalHorizontalOffset(int px) throws Resources.NotFoundException {
    ...
    public void setVerticalOffset(int px) throws Resources.NotFoundException {
    ...
    public void setVerticalOffsetWithoutText(int px) throws Resources.NotFoundException {
    ...
    public void setVerticalOffsetWithText(int px) throws Resources.NotFoundException {
    ...
    void setAdditionalVerticalOffset(int px) throws Resources.NotFoundException {
    ...
    private void setTextAppearanceResource(int id) throws Resources.NotFoundException {
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) throws Resources.NotFoundException {
        int i;
        float f;
        float f2;
