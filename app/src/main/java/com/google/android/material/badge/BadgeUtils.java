...
public class BadgeUtils {
    ...
    public static void attachBadgeDrawable(BadgeDrawable badgeDrawable, View anchor) throws Resources.NotFoundException {
        attachBadgeDrawable(badgeDrawable, anchor, (FrameLayout) null);
    }

    public static void attachBadgeDrawable(BadgeDrawable badgeDrawable, View anchor, FrameLayout customBadgeParent) throws Resources.NotFoundException {
    ...
    public static void detachBadgeDrawable(BadgeDrawable badgeDrawable, Toolbar toolbar, int menuItemId) throws Resources.NotFoundException {
        if (badgeDrawable == null) {
            return;
        }
        ActionMenuItemView menuItemView = ToolbarUtils.getActionMenuItemView(toolbar, menuItemId);
    ...
    static void setToolbarOffset(BadgeDrawable badgeDrawable, Resources resources) throws Resources.NotFoundException {
    ...
    static void removeToolbarOffset(BadgeDrawable badgeDrawable) throws Resources.NotFoundException {
        badgeDrawable.setAdditionalHorizontalOffset(0);
        badgeDrawable.setAdditionalVerticalOffset(0);
    }

    public static void setBadgeDrawableBounds(BadgeDrawable badgeDrawable, View anchor, FrameLayout compatBadgeParent) throws Resources.NotFoundException {
