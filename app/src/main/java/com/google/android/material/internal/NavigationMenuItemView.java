...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public void initialize(MenuItemImpl itemData, int menuType) throws Resources.NotFoundException {
    ...
    @Override // androidx.appcompat.view.menu.MenuView.ItemView
    public void setIcon(Drawable icon) throws Resources.NotFoundException {
        if (icon != null) {
    ...
    void setIconTintList(ColorStateList tintList) throws Resources.NotFoundException {
