...
public class MotionUtils {
    ...
    public static TimeInterpolator resolveThemeInterpolator(Context context, int attrResId, TimeInterpolator defaultInterpolator) throws NumberFormatException {
    ...
    private static float getControlPoint(String[] controlPoints, int index) throws NumberFormatException {
