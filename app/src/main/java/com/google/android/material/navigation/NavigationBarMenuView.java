...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    BadgeDrawable getOrCreateBadge(int menuItemId) throws Resources.NotFoundException {
    ...
    private void setBadgeIfNeeded(NavigationBarItemView child) throws Resources.NotFoundException {
