...
final class UnsafeReflectionAccessor extends ReflectionAccessor {
    ...
    public void makeAccessible(AccessibleObject ao) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    boolean makeAccessibleWithUnsafe(AccessibleObject ao) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
