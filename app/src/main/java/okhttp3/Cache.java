...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File directory, long maxSize, FileSystem fileSystem) {
        this.internalCache = new InternalCache() { // from class: okhttp3.Cache.1
            ...
            @Override // okhttp3.internal.cache.InternalCache
            public void update(Response cached, Response network) throws CertificateEncodingException {
    ...
    @Nullable
    CacheRequest put(Response response) throws CertificateEncodingException {
    ...
    void update(Response cached, Response network) throws CertificateEncodingException {
    ...
    private static final class Entry {
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException, CertificateEncodingException {
        ...
        private List<Certificate> readCertificateList(BufferedSource source) throws IOException, CertificateException {
        ...
        private void writeCertList(BufferedSink sink, List<Certificate> certificates) throws IOException, CertificateEncodingException {
            try {
        ...
        public Response response(DiskLruCache.Snapshot snapshot) {
            String contentType = this.responseHeaders.get(HTTP.CONTENT_TYPE);
            String contentLength = this.responseHeaders.get(HTTP.CONTENT_LEN);
