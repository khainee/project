...
class AndroidPlatform extends Platform {
    ...
    @Override // okhttp3.internal.platform.Platform
    public void configureTlsExtensions(SSLSocket sslSocket, String hostname, List<Protocol> protocols) throws Throwable {
        if (hostname != null) {
    ...
    private boolean api24IsCleartextTrafficPermitted(String hostname, Class<?> networkPolicyClass, Object networkSecurityPolicy) throws IllegalAccessException, NoSuchMethodException, SecurityException, InvocationTargetException {
        try {
    ...
    private boolean api23IsCleartextTrafficPermitted(String hostname, Class<?> networkPolicyClass, Object networkSecurityPolicy) throws IllegalAccessException, NoSuchMethodException, SecurityException, InvocationTargetException {
        try {
    ...
    static final class CloseGuard {
        ...
        Object createAndOpen(String closer) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        boolean warnIfOpen(Object closeGuardInstance) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
