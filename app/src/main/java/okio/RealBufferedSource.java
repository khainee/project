...
final class RealBufferedSource implements BufferedSource {
    ...
    public String readUtf8LineStrict(long limit) throws IOException {
        ...
        if (scanLength < LocationRequestCompat.PASSIVE_INTERVAL && request(scanLength) && this.buffer.getByte(scanLength - 1) == 13 && request(1 + scanLength) && this.buffer.getByte(scanLength) == 10) {
