...
public final class LocationRequestCompat {
    ...
    public LocationRequest toLocationRequest(String provider) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
