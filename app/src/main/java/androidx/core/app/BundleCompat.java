...
public final class BundleCompat {
    ...
    static class BundleCompatBaseImpl {
        ...
        public static IBinder getBinder(Bundle bundle, String key) throws NoSuchMethodException, SecurityException {
        ...
        public static void putBinder(Bundle bundle, String key, IBinder binder) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
