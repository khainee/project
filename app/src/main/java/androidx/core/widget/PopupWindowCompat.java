...
public final class PopupWindowCompat {
    ...
    public static void setOverlapAnchor(PopupWindow popupWindow, boolean overlapAnchor) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    public static void setWindowLayoutType(PopupWindow popupWindow, int layoutType) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
