...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static void init() throws NoSuchMethodException, ClassNotFoundException, SecurityException, NegativeArraySizeException {
    ...
    private static Object newFamily() throws NoSuchMethodException, ClassNotFoundException, SecurityException, NegativeArraySizeException {
        init();
        try {
    ...
    private static Typeface createFromFamiliesWithDefault(Object family) throws NoSuchMethodException, ClassNotFoundException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        init();
        try {
    ...
    private static boolean addFontWeightStyle(Object family, String name, int weight, boolean style) throws NoSuchMethodException, ClassNotFoundException, SecurityException, NegativeArraySizeException {
        init();
        try {
    ...
    @Override // androidx.core.graphics.TypefaceCompatBaseImpl
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry entry, Resources resources, int style) throws NoSuchMethodException, ClassNotFoundException, SecurityException, NegativeArraySizeException {
