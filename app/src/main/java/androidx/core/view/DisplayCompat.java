...
public final class DisplayCompat {
    ...
    private static Point getDisplaySize(Context context, Display display) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    private static String getSystemProperty(String name) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        try {
    ...
    private static Point parsePhysicalDisplaySizeFromSystemProperties(String property, Display display) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    static Point getCurrentDisplaySizeFromWorkarounds(Context context, Display display) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        Point displaySize;
    ...
    static class Api23Impl {
        ...
        static ModeCompat getMode(Context context, Display display) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        ...
        public static ModeCompat[] getSupportedModes(Context context, Display display) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
