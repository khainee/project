...
public final class ComplexColorCompat {
    ...
    */
    private static ComplexColorCompat createFromXml(Resources resources, int resId, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int type;
        char c;
