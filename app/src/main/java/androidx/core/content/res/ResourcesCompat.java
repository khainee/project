...
public final class ResourcesCompat {
    ...
    */
    private static Typeface loadFont(Context context, Resources wrapper, TypedValue value, int id, int style, FontCallback fontCallback, Handler handler, boolean isRequestFromLayoutInflator, boolean isCachedOnly) throws Resources.NotFoundException {
        String file;
        Typeface typeface;
