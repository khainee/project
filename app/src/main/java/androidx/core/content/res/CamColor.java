...
class CamColor {
    ...
    int viewed(ViewingConditions viewingConditions) {
        ...
        Double.isNaN(d);
        float t = (float) Math.pow(d / dPow, 1.1111111111111112d);
        ...
        double dAbs = Math.abs(rA);
        Double.isNaN(dAbs);
        float alpha2 = Math.abs(rA);
        double d4 = alpha2;
        Double.isNaN(d4);
        float rCBase = (float) Math.max(0.0d, (dAbs * 27.13d) / (400.0d - d4));
        float rC = Math.signum(rA) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow(rCBase, 2.380952380952381d));
        double dAbs2 = Math.abs(gA);
        Double.isNaN(dAbs2);
        double dAbs3 = Math.abs(gA);
        Double.isNaN(dAbs3);
        float gCBase = (float) Math.max(0.0d, (dAbs2 * 27.13d) / (400.0d - dAbs3));
        float gC = Math.signum(gA) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow(gCBase, 2.380952380952381d));
        double dAbs4 = Math.abs(bA);
        Double.isNaN(dAbs4);
        double dAbs5 = Math.abs(bA);
        Double.isNaN(dAbs5);
        float bCBase = (float) Math.max(0.0d, (dAbs4 * 27.13d) / (400.0d - dAbs5));
