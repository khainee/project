...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(Spannable text, int mask) throws UnsupportedEncodingException {
    ...
    private static void gatherMapLinks(ArrayList<LinkSpec> links, Spannable s) throws UnsupportedEncodingException {
        int start;
