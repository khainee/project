...
public class SortedList<T> {
    ...
    public T removeItemAt(int index) throws IndexOutOfBoundsException {
        throwIfInMutationOperation();
        T item = get(index);
    ...
    public void updateItemAt(int index, T item) throws IndexOutOfBoundsException {
        throwIfInMutationOperation();
    ...
    public void recalculatePositionOfItemAt(int index) throws IndexOutOfBoundsException {
        throwIfInMutationOperation();
        T item = get(index);
        removeItemAtIndex(index, false);
        int newIndex = add(item, false);
