...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setBackground(viewFindViewById, a.getDrawable(androidx.appcompat.R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(viewFindViewById2, a.getDrawable(androidx.appcompat.R.styleable.SearchView_submitBackground));
