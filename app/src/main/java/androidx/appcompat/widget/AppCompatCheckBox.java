...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public void setButtonDrawable(Drawable buttonDrawable) throws NoSuchFieldException {
    ...
    @Override // android.widget.CompoundButton
    public void setButtonDrawable(int resId) throws NoSuchFieldException {
    ...
    public void setSupportButtonTintList(ColorStateList tint) throws NoSuchFieldException {
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.mCompoundButtonHelper;
        if (appCompatCompoundButtonHelper != null) {
    ...
    @Override // androidx.core.widget.TintableCompoundButton
    public void setSupportButtonTintMode(PorterDuff.Mode tintMode) throws NoSuchFieldException {
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.mCompoundButtonHelper;
        if (appCompatCompoundButtonHelper != null) {
