...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) throws NoSuchFieldException {
        int childHeightSpec;
        View topPanel = null;
    ...
    private static int resolveMinimumHeight(View v) throws NoSuchFieldException {
