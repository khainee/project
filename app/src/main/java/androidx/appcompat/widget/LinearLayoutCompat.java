                ...
                if (child2 == null) {
                    ...
                    if (largestChildHeight4 == 8) {
                        ...
                        if (heightMode4 != 1073741824 || lp2.height != 0 || lp2.weight <= 0.0f) {
                            ...
                            int i5 = totalWeight3 == 0.0f ? this.mTotalLength : 0;
                        ...
                        if (lp.weight > 0.0f) {
                            weightedMaxWidth3 = Math.max(weightedMaxWidth2, matchWidthLocally ? margin : measuredWidth2);
                        } else {
                            weightedMaxWidth3 = weightedMaxWidth2;
                            alternativeMaxWidth3 = Math.max(alternativeMaxWidth3, matchWidthLocally ? margin : measuredWidth2);
                        }
                        int alternativeMaxWidth5 = getChildrenSkipCount(child, i2);
                        int i10 = alternativeMaxWidth5 + i2;
                            ...
                            while (i13 < count) {
                                ...
                                if (child4 != null) {
                                    ...
                                    if (alternativeMaxWidth8 == 8) {
                                        ...
                                        child4.measure(iMakeMeasureSpec, weightedMaxWidth8);
                                    } else {
                                        weightedMaxWidth = weightedMaxWidth7;
                                    }
                                } else {
                ...
                while (i14 < count) {
                    ...
                    if (largestChildHeight8 == 8) {
                        ...
                        if (widthMode != 1073741824) {
                            ...
                            int alternativeMaxWidth9 = Math.max(alternativeMaxWidth6, !matchWidthLocally2 ? margin2 : measuredWidth3);
                            int i15 = (largestChildHeight2 == 0 && lp4.width == -1) ? 1 : 0;
                            ...
                            this.mTotalLength = Math.max(totalLength4, measuredHeight + alternativeMaxWidth10 + lp4.bottomMargin + getNextLocationOffset(child5));
                            largestChildHeight2 = i15;
                            weightSum2 = weightSum;
                            alternativeMaxWidth6 = alternativeMaxWidth9;
                        } else {
                            weightSum = weightSum2;
                        }
                        int alternativeMaxWidth92 = Math.max(alternativeMaxWidth6, !matchWidthLocally2 ? margin2 : measuredWidth3);
                        ...
                        this.mTotalLength = Math.max(totalLength42, measuredHeight2 + alternativeMaxWidth102 + lp4.bottomMargin + getNextLocationOffset(child5));
                        largestChildHeight2 = i15;
                        weightSum2 = weightSum;
