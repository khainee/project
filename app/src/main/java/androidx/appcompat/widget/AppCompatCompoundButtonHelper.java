...
class AppCompatCompoundButtonHelper {
    ...
    void setSupportButtonTintList(ColorStateList tint) throws NoSuchFieldException {
    ...
    void setSupportButtonTintMode(PorterDuff.Mode tintMode) throws NoSuchFieldException {
