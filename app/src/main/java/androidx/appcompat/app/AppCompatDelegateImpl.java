...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onCreate(Bundle savedInstanceState) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        this.mBaseContextAttached = true;
        applyDayNight(false);
        ensureWindow();
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onConfigurationChanged(Configuration newConfig) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        ActionBar ab;
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    final int updateStatusGuard(WindowInsetsCompat insets, Rect rectInsets) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (this.mActionModeView.isShown()) {
            ...
            if (!this.mOverlayActionMode && showStatusGuard2) {
                ...
                systemWindowInsetTop3 = systemWindowInsetTop2;
            }
            showStatusGuard = showStatusGuard2;
            systemWindowInsetTop = systemWindowInsetTop3;
        } else {
            int systemWindowInsetTop6 = systemWindowInsetTop4;
            if (mlp.topMargin != 0) {
                mlpChanged = true;
                mlp.topMargin = 0;
                systemWindowInsetTop = systemWindowInsetTop6;
            } else {
                systemWindowInsetTop = systemWindowInsetTop6;
            }
        }
    ...
    private boolean applyDayNight(boolean allowRecreation) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    private boolean updateForNightMode(int mode, boolean allowRecreation) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        boolean handled = false;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void updateResourcesConfigurationForNightMode(int uiModeNightModeValue, boolean callOnConfigChange, Configuration configOverlay) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
