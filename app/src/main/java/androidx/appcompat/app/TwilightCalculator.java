...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double dSin = Math.sin(meanAnomaly) * 0.03341960161924362d;
        Double.isNaN(d);
        double trueAnomaly = d + dSin + (Math.sin(2.0f * meanAnomaly) * 3.4906598739326E-4d) + (Math.sin(3.0f * meanAnomaly) * 5.236000106378924E-6d);
        ...
        double d5 = hourAngle;
        Double.isNaN(d5);
        long jRound = Math.round((solarTransitJ2000 - d5) * 8.64E7d) + UTC_2000;
        this.sunrise = jRound;
