    ...
    private static void horizontalSolvingPass(int level, ConstraintWidget layout, BasicMeasure.Measurer measurer, boolean isRtl) {
        ...
        if (left.getDependents() != null && left.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                if (widget.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                    ...
                    if ((((first == widget.mLeft && widget.mRight.mTarget != null && widget.mRight.mTarget.hasFinalValue()) || (first == widget.mRight && widget.mLeft.mTarget != null && widget.mLeft.mTarget.hasFinalValue())) ? EARLY_TERMINATION : false) && !widget.isInHorizontalChain()) {
        ...
        if (right.getDependents() != null && right.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean bothConnected = ((first2 == widget2.mLeft && widget2.mRight.mTarget != null && widget2.mRight.mTarget.hasFinalValue()) || (first2 == widget2.mRight && widget2.mLeft.mTarget != null && widget2.mLeft.mTarget.hasFinalValue())) ? EARLY_TERMINATION : false;
    ...
    private static void verticalSolvingPass(int level, ConstraintWidget layout, BasicMeasure.Measurer measurer) {
        ...
        if (top.getDependents() != null && top.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                if (widget.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                    ...
                    if ((((first == widget.mTop && widget.mBottom.mTarget != null && widget.mBottom.mTarget.hasFinalValue()) || (first == widget.mBottom && widget.mTop.mTarget != null && widget.mTop.mTarget.hasFinalValue())) ? EARLY_TERMINATION : false) && !widget.isInVerticalChain()) {
        ...
        if (bottom.getDependents() != null && bottom.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean bothConnected = ((first2 == widget2.mTop && widget2.mBottom.mTarget != null && widget2.mBottom.mTarget.hasFinalValue()) || (first2 == widget2.mBottom && widget2.mTop.mTarget != null && widget2.mTop.mTarget.hasFinalValue())) ? EARLY_TERMINATION : false;
