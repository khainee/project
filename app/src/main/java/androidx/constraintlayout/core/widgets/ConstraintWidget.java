...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:319:0x062a  */
    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        if (f <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT || this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT || matchConstraintDefaultWidth2 != 3 || matchConstraintDefaultHeight2 != 3) {
                ...
                } else if (!optimize || (horizontalWidgetRun = this.horizontalRun) == null || !horizontalWidgetRun.start.resolved || !this.horizontalRun.end.resolved) {
                    ...
                    if (applyVerticalConstraints && !constraintWidget3.resolvedVertical) {
                        ...
                        if (constraintWidget3.mBaselineDistance > 0 || constraintWidget3.mVisibility == i) {
                            if (constraintWidget3.mBaseline.mTarget != null) {
                                ...
                                if (constraintWidget3.mVisibility == i) {
                            ...
                            applyPosition2 = applyPosition;
                            boolean z322 = constraintWidget3.isTerminalWidget[c];
                            DimensionBehaviour[] dimensionBehaviourArr222 = constraintWidget3.mListDimensionBehaviors;
                            applyConstraints(system, false, verticalParentWrapContent4, horizontalParentWrapContent2, z322, parentMin2, parentMax2, dimensionBehaviourArr222[c], wrapContent2, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, height3, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[c], constraintWidget3.mVerticalBiasPercent, useVerticalRatio, dimensionBehaviourArr222[0] == DimensionBehaviour.MATCH_CONSTRAINT, inVerticalChain, inHorizontalChain, isInVerticalBarrier, matchConstraintDefaultHeight, matchConstraintDefaultWidth, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, applyPosition2);
                        }
                    }
                    if (useRatio2) {
    ...
    */
    private void applyConstraints(LinearSystem system, boolean isHorizontal, boolean parentWrapContent, boolean oppositeParentWrapContent, boolean isTerminal, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean oppositeVariable, boolean inChain, boolean oppositeInChain, boolean inBarrier, int matchConstraintDefault, int oppositeMatchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        if (!applyPosition || inChain) {
            ...
            ConstraintWidget constraintWidget4 = this;
            ...
            if (numConnections4 < 2 && parentWrapContent && isTerminal4) {
                ...
                boolean applyEnd = isHorizontal || constraintWidget4.mBaseline.mTarget == null;
                if (!isHorizontal && constraintWidget4.mBaseline.mTarget != null) {
                    ConstraintWidget target = constraintWidget4.mBaseline.mTarget.mOwner;
                    applyEnd = target.mDimensionRatio != 0.0f && target.mListDimensionBehaviors[i2] == DimensionBehaviour.MATCH_CONSTRAINT && target.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT;
                }
                if (applyEnd) {
        ...
        if (isBeginConnected || isEndConnected || isCenterConnected) {
            if (isBeginConnected && !isEndConnected) {
                ...
                if (!parentWrapContent) {
                    ...
                    endTarget2 = endTarget;
                } else if (this.OPTIMIZE_WRAP && begin3.isFinalValue && (constraintWidget2 = this.mParent) != null) {
                    ConstraintWidgetContainer container = (ConstraintWidgetContainer) constraintWidget2;
                    if (isHorizontal) {
                ...
                if (applyCentering2 && beginTarget2 == endTarget2) {
                    ...
                    if (!parentWrapContent2 && variableSize2 && minDimension == 0 && matchMinDimension2 == 0) {
                        if (variableSize2 && matchConstraintDefault3 == 3) {
                            ...
                            int i3 = 0;
                            system.addGreaterThan(end2, begin2, i3, matchConstraintDefault2);
                        }
                    }
                } else {
                    parent2 = parent;
            ...
            if (endTarget2 != parentMax) {
                if (!constraintWidget.OPTIMIZE_WRAP || !end2.isFinalValue || (constraintWidget3 = constraintWidget.mParent) == null) {
