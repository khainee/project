...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motion == null) {
            ...
            Double.isNaN(d10);
            Double.isNaN(d9);
            double d11 = d9 + (d10 * dSin2);
            double dCos2 = Math.cos(angle);
            double d12 = dangle2;
            Double.isNaN(d12);
            float dpos_x = (float) (d11 + (dCos2 * d12));
            double d13 = v_x3;
            double d14 = dradius;
            double dCos3 = Math.cos(angle);
            Double.isNaN(d14);
            Double.isNaN(d13);
            double d15 = d13 - (d14 * dCos3);
            double dSin3 = Math.sin(angle);
            double d16 = dangle2;
            Double.isNaN(d16);
            v_x = v_x4;
            dangle = dpos_x;
            v_y = v_y2;
            v_x2 = (float) (d15 + (dSin3 * d16));
        }
        ...
        while (true) {
            ...
            if (i2 < dArr.length) {
                ...
                if (motion != null) {
                    ...
                    double dSin = Math.sin(v_y4);
                    Double.isNaN(d2);
                    Double.isNaN(d);
                    double d3 = d + (d2 * dSin);
                    double d4 = v_width3 / 2.0f;
                    Double.isNaN(d4);
                    float pos_x = (float) (d3 - d4);
                    double d5 = ry;
                    double d6 = radius;
                    double dCos = Math.cos(v_y4);
                    Double.isNaN(d6);
                    Double.isNaN(d5);
                    double d7 = d5 - (d6 * dCos);
                    double d8 = v_height2 / 2.0f;
                    Double.isNaN(d8);
                    float pos_y = (float) (d7 - d8);
                    double d9 = drx;
                    double d10 = dradius;
                    v_width = v_width3;
                    v_height = v_height2;
                    double dSin2 = Math.sin(v_y4);
                    Double.isNaN(d10);
                    Double.isNaN(d9);
                    double d11 = d9 + (d10 * dSin2);
                    double d12 = radius;
                    double dCos2 = Math.cos(v_y4);
                    Double.isNaN(d12);
                    double d13 = dangle;
                    Double.isNaN(d13);
                    float dpos_x = (float) (d11 + (d12 * dCos2 * d13));
                    double d14 = dry;
                    double d15 = dradius;
                    double dCos3 = Math.cos(v_y4);
                    Double.isNaN(d15);
                    Double.isNaN(d14);
                    double d16 = d14 - (d15 * dCos3);
                    double d17 = radius;
                    double dSin3 = Math.sin(v_y4);
                    Double.isNaN(d17);
                    double d18 = d17 * dSin3;
                    double d19 = dangle;
                    Double.isNaN(d19);
                    float dpos_y = (float) (d16 + (d18 * d19));
                    v_x = pos_x;
                    if (slope.length >= 2) {
                        slope[0] = dpos_x;
                        slope[1] = dpos_y;
                    ...
                    if (!Float.isNaN(path_rotate2)) {
                        ...
                        double d21 = 0.0f;
                        double d22 = path_rotate2;
                        double degrees2 = Math.toDegrees(Math.atan2(dy, dx));
                        Double.isNaN(d22);
                        Double.isNaN(d21);
                        float rot2 = (float) (d21 + d22 + degrees2);
    ...
    void getRect(int[] toUse, double[] data, float[] path, int offset) {
        ...
        while (true) {
            ...
            if (i < toUse.length) {
                ...
                if (angle != 0.0f) {
                    float v_x2 = angle;
                    float sin = (float) Math.sin(Math.toRadians(v_x2));
                    float cos = (float) Math.cos(Math.toRadians(v_x2));
                    float f = cx;
                    float f2 = cy;
                    float f3 = x1;
                    float f4 = y1;
