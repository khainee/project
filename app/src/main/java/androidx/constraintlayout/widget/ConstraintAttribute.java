...
public class ConstraintAttribute {
        ...
        for (String name : base.keySet()) {
            ...
            try {
                if (name.equals("BackgroundColor")) {
                    ...
                    Method method = cls.getMethod(strValueOf.length() != 0 ? "getMap".concat(strValueOf) : new String("getMap"), new Class[0]);
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        for (String name : map.keySet()) {
            ...
            if (!constraintAttribute.mMethod) {
                ...
                methodName = strValueOf.length() != 0 ? "set".concat(strValueOf) : new String("set");
            }
            try {
    ...
    public void setInterpolatedValue(View view, float[] value) {
        ...
        String methodName = strValueOf.length() != 0 ? "set".concat(strValueOf) : new String("set");
        try {
            switch (this.mType) {
                case BOOLEAN_TYPE:
