...
public class ConstraintSet {
        ...
        private ConstraintAttribute get(String attributeName, ConstraintAttribute.AttributeType attributeType) {
            if (this.mCustomConstraints.containsKey(attributeName)) {
                ...
                if (ret.getType() != attributeType) {
                    String strValueOf = String.valueOf(ret.getType().name());
                    throw new IllegalArgumentException(strValueOf.length() != 0 ? "ConstraintAttribute is already a ".concat(strValueOf) : new String("ConstraintAttribute is already a "));
                }
                return ret;
            }
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            ...
            if (constraint != null) {
                this.mConstraints.put(key, constraint.m4clone());
            }
        }
    }
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            int id = view.getId();
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                String strValueOf = String.valueOf(Debug.getName(view));
                Log.w(TAG, strValueOf.length() != 0 ? "id unknown ".concat(strValueOf) : new String("id unknown "));
            } else {
                if (this.mForceId && id == -1) {
                    throw new RuntimeException("All children of ConstraintLayout must have ids to use ConstraintSet");
                }
        ...
        switch (startSide) {
            case 1:
                if (endSide == 1) {
                    ...
                    String strSideToString = sideToString(endSide);
            ...
            case 2:
                if (endSide == 1) {
                    ...
                    String strSideToString2 = sideToString(endSide);
            ...
            case 3:
                if (endSide == 3) {
                    ...
                    String strSideToString3 = sideToString(endSide);
            ...
            case 4:
                if (endSide == 4) {
                    ...
                    String strSideToString4 = sideToString(endSide);
            ...
            case 5:
                ...
                String strSideToString5 = sideToString(endSide);
            ...
            case 6:
                if (endSide == 6) {
                    ...
                    String strSideToString6 = sideToString(endSide);
            ...
            case 7:
                if (endSide == 7) {
                    ...
                    String strSideToString7 = sideToString(endSide);
                ...
                return;
            default:
                String strSideToString8 = sideToString(startSide);
                String strSideToString9 = sideToString(endSide);
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < sp.length; i++) {
            ...
            if (attr.length == 2) {
                ...
                String strValueOf = String.valueOf(sp[i]);
                Log.w(TAG, strValueOf.length() != 0 ? " Unable to parse ".concat(strValueOf) : new String(" Unable to parse "));
            }
        }
    }
    ...
    */
                    ...
                    switch (eventType) {
                        ...
                        case 2:
                            ...
                            switch (c2) {
                                ...
                                case 5:
                                    if (constraint == null) {
                                        int lineNumber2 = parser.getLineNumber();
                                ...
                                case 6:
                                    if (constraint == null) {
                                        int lineNumber3 = parser.getLineNumber();
                                ...
                                case 7:
                                    if (constraint == null) {
                                        int lineNumber4 = parser.getLineNumber();
                                ...
                                case '\t':
                                    if (constraint == null) {
                                        int lineNumber5 = parser.getLineNumber();
    ...
    class WriteXmlEngine {
        ...
        void writeXmlConstraint(String str, int leftToLeft) throws IOException {
            ...
            Writer writer = this.writer;
            String strValueOf = String.valueOf(SPACE);
        ...
        void writeConstraint(String my, int leftToLeft, String other, int margin, int goneMargin) throws IOException {
            ...
            Writer writer = this.writer;
            String strValueOf = String.valueOf(SPACE);
            String strValueOf2 = String.valueOf(my);
            writer.write(strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf));
            this.writer.write(":[");
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            while (i < value.length) {
                Writer writer2 = this.writer;
                String strValueOf3 = String.valueOf(i == 0 ? "[" : ", ");
                String strValueOf4 = String.valueOf(getName(value[i]));
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            writer.write(strValueOf.length() != 0 ? ", ".concat(strValueOf) : new String(", "));
            this.writer.write("\n");
        }
    }
    ...
    class WriteJsonEngine {
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            writer2.write(strValueOf3.length() != 0 ? ", ".concat(strValueOf3) : new String(", "));
            this.writer.write("\n");
        }
    }
}
