            ...
            if (view != null) {
                ...
                if (iArr != null && i < iArr.length) {
                    ...
                    if (num != null && num.intValue() != -1) {
                        ...
                        String strValueOf = String.valueOf(this.mMap.get(Integer.valueOf(view.getId())));
                        Log.e(TAG, strValueOf.length() != 0 ? "Added radius to view with id: ".concat(strValueOf) : new String("Added radius to view with id: "));
                    }
                }
                ...
                if (fArr != null && i < fArr.length) {
                    ...
                    if (f != null && f.floatValue() != -1.0f) {
                        ...
                        String strValueOf2 = String.valueOf(this.mMap.get(Integer.valueOf(view.getId())));
                        Log.e(TAG, strValueOf2.length() != 0 ? "Added angle to view with id: ".concat(strValueOf2) : new String("Added angle to view with id: "));
                    }
                }
