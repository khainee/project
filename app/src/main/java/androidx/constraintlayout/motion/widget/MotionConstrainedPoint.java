                    ...
                    if (s.startsWith("CUSTOM")) {
                        ...
                        if (this.attributes.containsKey(customName)) {
                            ...
                            if (ViewSpline instanceof ViewSpline.CustomSet) {
                                ...
                                StringBuilder sb = new StringBuilder(String.valueOf(s).length() + 69 + String.valueOf(strValueOf).length());
                                sb.append(s);
                        ...
                        Log.e("MotionPaths", strValueOf2.length() != 0 ? "UNKNOWN spline ".concat(strValueOf2) : new String("UNKNOWN spline "));
                        break;
                    }
            }
        }
