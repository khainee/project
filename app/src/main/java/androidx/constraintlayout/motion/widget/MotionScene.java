...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public String debugString(Context context) throws Resources.NotFoundException {
            ...
            String strValueOf = String.valueOf(ret);
    ...
    */
                    ...
                    switch (eventType) {
                        ...
                        case 2:
                            ...
                            if (this.DEBUG_DESKTOP) {
                                ...
                                String strValueOf = String.valueOf(tagName);
                                printStream.println(strValueOf.length() != 0 ? "parsing = ".concat(strValueOf) : new String("parsing = "));
                            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private int parseConstraintSet(Context context, XmlPullParser parser) throws NumberFormatException {
        String value;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (this.DEBUG_DESKTOP) {
                ...
                printStream.println(strValueOf.length() != 0 ? "id string = ".concat(strValueOf) : new String("id string = "));
            }
            switch (name) {
                case "id":
    ...
    public ConstraintSet getConstraintSet(Context context, String id) throws Resources.NotFoundException {
        if (this.DEBUG_DESKTOP) {
            ...
            printStream.println(strValueOf.length() != 0 ? "id ".concat(strValueOf) : new String("id "));
    ...
    private void readConstraintChain(int key, MotionLayout motionLayout) {
        ...
        if (derivedFromId > 0) {
            ...
            if (derivedFrom == null) {
                String strValueOf = String.valueOf(Debug.getName(this.mMotionLayout.getContext(), derivedFromId));
            ...
            String strValueOf2 = String.valueOf(cs.derivedState);
