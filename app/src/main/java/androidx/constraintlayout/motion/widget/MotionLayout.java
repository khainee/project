    ...
    */
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            ...
            String strValueOf2 = String.valueOf(params.startToStart != -1 ? "SS" : "__");
            String a = strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf);
            String strValueOf3 = String.valueOf(a);
            String strValueOf4 = String.valueOf(params.startToEnd != -1 ? "|SE" : "|__");
            String a2 = strValueOf4.length() != 0 ? strValueOf3.concat(strValueOf4) : new String(strValueOf3);
            String strValueOf5 = String.valueOf(a2);
            String strValueOf6 = String.valueOf(params.endToStart != -1 ? "|ES" : "|__");
            String a3 = strValueOf6.length() != 0 ? strValueOf5.concat(strValueOf6) : new String(strValueOf5);
            String strValueOf7 = String.valueOf(a3);
            String strValueOf8 = String.valueOf(params.endToEnd != -1 ? "|EE" : "|__");
            String a4 = strValueOf8.length() != 0 ? strValueOf7.concat(strValueOf8) : new String(strValueOf7);
            String strValueOf9 = String.valueOf(a4);
            String strValueOf10 = String.valueOf(params.leftToLeft != -1 ? "|LL" : "|__");
            String a5 = strValueOf10.length() != 0 ? strValueOf9.concat(strValueOf10) : new String(strValueOf9);
            String strValueOf11 = String.valueOf(a5);
            String strValueOf12 = String.valueOf(params.leftToRight != -1 ? "|LR" : "|__");
            String a6 = strValueOf12.length() != 0 ? strValueOf11.concat(strValueOf12) : new String(strValueOf11);
            String strValueOf13 = String.valueOf(a6);
            String strValueOf14 = String.valueOf(params.rightToLeft != -1 ? "|RL" : "|__");
            String a7 = strValueOf14.length() != 0 ? strValueOf13.concat(strValueOf14) : new String(strValueOf13);
            String strValueOf15 = String.valueOf(a7);
            String strValueOf16 = String.valueOf(params.rightToRight != -1 ? "|RR" : "|__");
            String a8 = strValueOf16.length() != 0 ? strValueOf15.concat(strValueOf16) : new String(strValueOf15);
            String strValueOf17 = String.valueOf(a8);
            String strValueOf18 = String.valueOf(params.topToTop != -1 ? "|TT" : "|__");
            String a9 = strValueOf18.length() != 0 ? strValueOf17.concat(strValueOf18) : new String(strValueOf17);
            String strValueOf19 = String.valueOf(a9);
            String strValueOf20 = String.valueOf(params.topToBottom != -1 ? "|TB" : "|__");
            String a10 = strValueOf20.length() != 0 ? strValueOf19.concat(strValueOf20) : new String(strValueOf19);
            String strValueOf21 = String.valueOf(a10);
            String strValueOf22 = String.valueOf(params.bottomToTop != -1 ? "|BT" : "|__");
            String a11 = strValueOf22.length() != 0 ? strValueOf21.concat(strValueOf22) : new String(strValueOf21);
            String strValueOf23 = String.valueOf(a11);
            String strValueOf24 = String.valueOf(params.bottomToBottom != -1 ? "|BB" : "|__");
            String a12 = strValueOf24.length() != 0 ? strValueOf23.concat(strValueOf24) : new String(strValueOf23);
            String strValueOf25 = String.valueOf(str);
            String strValueOf26 = String.valueOf(a12);
            Log.v(MotionLayout.TAG, strValueOf26.length() != 0 ? strValueOf25.concat(strValueOf26) : new String(strValueOf25));
        }
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mTop.mTarget != null) {
                String strValueOf2 = String.valueOf(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B");
                strConcat = strValueOf2.length() != 0 ? "T".concat(strValueOf2) : new String("T");
            } else {
                strConcat = "__";
            }
            String strValueOf3 = String.valueOf(strConcat);
            String a = strValueOf3.length() != 0 ? strValueOf.concat(strValueOf3) : new String(strValueOf);
            String strValueOf4 = String.valueOf(a);
            if (child.mBottom.mTarget != null) {
                String strValueOf5 = String.valueOf(child.mBottom.mTarget.mType != ConstraintAnchor.Type.TOP ? "B" : "T");
                strConcat2 = strValueOf5.length() != 0 ? "B".concat(strValueOf5) : new String("B");
            } else {
                strConcat2 = "__";
            }
            String strValueOf6 = String.valueOf(strConcat2);
            String a2 = strValueOf6.length() != 0 ? strValueOf4.concat(strValueOf6) : new String(strValueOf4);
            String strValueOf7 = String.valueOf(a2);
            if (child.mLeft.mTarget != null) {
                String strValueOf8 = String.valueOf(child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
                strConcat3 = strValueOf8.length() != 0 ? "L".concat(strValueOf8) : new String("L");
            } else {
                strConcat3 = "__";
            }
            String strValueOf9 = String.valueOf(strConcat3);
            String a3 = strValueOf9.length() != 0 ? strValueOf7.concat(strValueOf9) : new String(strValueOf7);
            String strValueOf10 = String.valueOf(a3);
            if (child.mRight.mTarget != null) {
                String strValueOf11 = String.valueOf(child.mRight.mTarget.mType != ConstraintAnchor.Type.LEFT ? "R" : "L");
                strConcat4 = strValueOf11.length() != 0 ? "R".concat(strValueOf11) : new String("R");
            }
            String strValueOf12 = String.valueOf(strConcat4);
            String a4 = strValueOf12.length() != 0 ? strValueOf10.concat(strValueOf12) : new String(strValueOf10);
            String strValueOf13 = String.valueOf(child);
            StringBuilder sb = new StringBuilder(String.valueOf(str).length() + 6 + String.valueOf(a4).length() + String.valueOf(strValueOf13).length());
            sb.append(str);
            sb.append(a4);
            sb.append(" ---  ");
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            StringBuilder sb2 = new StringBuilder(String.valueOf(cName).length() + 12 + String.valueOf(strValueOf).length());
            sb2.append(cName);
            sb2.append("  ========= ");
            sb2.append(strValueOf);
            Log.v(MotionLayout.TAG, sb2.toString());
            ...
            for (int i = 0; i < count; i++) {
                ...
                String strValueOf3 = String.valueOf(child.mTop.mTarget != null ? "T" : "_");
                String a = strValueOf3.length() != 0 ? strValueOf2.concat(strValueOf3) : new String(strValueOf2);
                String strValueOf4 = String.valueOf(a);
                String strValueOf5 = String.valueOf(child.mBottom.mTarget != null ? "B" : "_");
                String a2 = strValueOf5.length() != 0 ? strValueOf4.concat(strValueOf5) : new String(strValueOf4);
                String strValueOf6 = String.valueOf(a2);
                String strValueOf7 = String.valueOf(child.mLeft.mTarget != null ? "L" : "_");
                String a3 = strValueOf7.length() != 0 ? strValueOf6.concat(strValueOf7) : new String(strValueOf6);
                String strValueOf8 = String.valueOf(a3);
                String strValueOf9 = String.valueOf(child.mRight.mTarget != null ? "R" : "_");
                String a4 = strValueOf9.length() != 0 ? strValueOf8.concat(strValueOf9) : new String(strValueOf8);
                View v = (View) child.getCompanionWidget();
                String name2 = Debug.getName(v);
                if (v instanceof TextView) {
                    String strValueOf10 = String.valueOf(name2);
                    String strValueOf11 = String.valueOf(((TextView) v).getText());
                ...
                String strValueOf12 = String.valueOf(child);
                StringBuilder sb5 = new StringBuilder(String.valueOf(str).length() + 4 + String.valueOf(name2).length() + String.valueOf(strValueOf12).length() + String.valueOf(a4).length());
                sb5.append(str);
                sb5.append("  ");
                sb5.append(name2);
                sb5.append(" ");
                ...
                sb5.append(" ");
                sb5.append(a4);
                Log.v(MotionLayout.TAG, sb5.toString());
            }
            Log.v(MotionLayout.TAG, String.valueOf(cName).concat(" done. "));
        }
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> frameArrayList, int duration, int debugPath) throws Resources.NotFoundException {
    ...
    protected void dispatchDraw(Canvas canvas) throws Resources.NotFoundException {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            StringBuilder sb2 = new StringBuilder(String.valueOf(strValueOf).length() + 36 + String.valueOf(state2).length() + String.valueOf(state3).length());
            sb2.append(strValueOf);
            sb2.append(state2);
            sb2.append(" (progress: ");
            sb2.append(p);
    ...
    private void checkStructure() {
        ...
        while (it.hasNext()) {
            ...
            if (this.mScene.getConstraintSet(startId2) == null) {
                String strValueOf = String.valueOf(startString);
                Log.e(TAG, strValueOf.length() != 0 ? " no such constraintSetStart ".concat(strValueOf) : new String(" no such constraintSetStart "));
            }
            if (this.mScene.getConstraintSet(endId) == null) {
                String strValueOf2 = String.valueOf(startString);
                Log.e(TAG, strValueOf2.length() != 0 ? " no such constraintSetEnd ".concat(strValueOf2) : new String(" no such constraintSetEnd "));
            }
        }
    }
    ...
    void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) throws Resources.NotFoundException {
        ...
        String strValueOf = String.valueOf(idName);
        Log.w(TAG, strValueOf.length() != 0 ? "WARNING could not find view id ".concat(strValueOf) : new String("WARNING could not find view id "));
    }
