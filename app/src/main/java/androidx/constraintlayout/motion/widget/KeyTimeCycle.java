    ...
    public void setInterpolation(HashMap<String, Integer> interpolation) {
        ...
        if (this.mCustomConstraints.size() > 0) {
            for (String s : this.mCustomConstraints.keySet()) {
                String strValueOf = String.valueOf("CUSTOM,");
                String strValueOf2 = String.valueOf(s);
                interpolation.put(strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf), Integer.valueOf(this.mCurveFit));
            }
        }
    }
            ...
            if (splineSet != null) {
                ...
                if (s.startsWith("CUSTOM")) {
                    ...
                    switch (c) {
                        ...
                        default:
                            StringBuilder sb = new StringBuilder(String.valueOf(s).length() + 20);
