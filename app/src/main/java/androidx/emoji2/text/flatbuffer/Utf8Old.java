...
public class Utf8Old extends Utf8 {
    ...
    public int encodedLength(CharSequence in) throws CharacterCodingException {
    ...
    @Override // androidx.emoji2.text.flatbuffer.Utf8
    public void encodeUtf8(CharSequence in, ByteBuffer out) throws CharacterCodingException {
        Cache cache = CACHE.get();
    ...
    @Override // androidx.emoji2.text.flatbuffer.Utf8
    public String decodeUtf8(ByteBuffer buffer, int offset, int length) throws CharacterCodingException {
