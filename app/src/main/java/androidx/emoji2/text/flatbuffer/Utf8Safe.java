...
public final class Utf8Safe extends Utf8 {
    ...
    public static String decodeUtf8Array(byte[] bytes, int index, int size) throws IllegalArgumentException {
    ...
    public static String decodeUtf8Buffer(ByteBuffer buffer, int offset, int length) throws IllegalArgumentException {
