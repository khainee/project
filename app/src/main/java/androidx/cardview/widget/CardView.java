...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException {
        int color;
        ...
        float maxElevation = a.getDimension(androidx.cardview.R.styleable.CardView_cardMaxElevation, 0.0f);
