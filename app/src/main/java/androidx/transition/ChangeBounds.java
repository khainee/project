...
public class ChangeBounds extends Transition {
    ...
    @Override // androidx.transition.Transition
    @Nullable
    public Animator createAnimator(@NonNull final ViewGroup sceneRoot, @Nullable TransitionValues startValues, @Nullable TransitionValues endValues) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Animator anim;
            ...
            if (numChanges > 0) {
                ...
                if (view.getParent() instanceof ViewGroup) {
                    ...
                    Transition.TransitionListener transitionListener = new TransitionListenerAdapter() { // from class: androidx.transition.ChangeBounds.9
                        ...
                        public void onTransitionCancel(@NonNull Transition transition) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
