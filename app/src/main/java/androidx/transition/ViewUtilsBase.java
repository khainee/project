...
class ViewUtilsBase {
    ...
    public void setLeftTopRightBottom(@NonNull View v, int left, int top, int right, int bottom) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        fetchSetFrame();
    ...
    public void setTransitionVisibility(@NonNull View view, int visibility) throws IllegalAccessException, IllegalArgumentException {
