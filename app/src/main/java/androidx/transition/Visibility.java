...
public abstract class Visibility extends Transition {
    ...
    private static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        DisappearListener(View view, int finalVisibility, boolean suppressLayout) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            this.mView = view;
        ...
        private void suppressLayout(boolean suppress) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
