...
class ViewUtils {
    ...
    static void setTransitionVisibility(@NonNull View view, int visibility) throws IllegalAccessException, IllegalArgumentException {
    ...
    static void setLeftTopRightBottom(@NonNull View v, int left, int top, int right, int bottom) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
