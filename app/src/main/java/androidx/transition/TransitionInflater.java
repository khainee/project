...
public class TransitionInflater {
    ...
    */
    private Transition createTransitionFromXml(XmlPullParser parser, AttributeSet attrs, Transition parent) throws XmlPullParserException, IOException, ClassNotFoundException {
    ...
    private void getTargetIds(XmlPullParser parser, AttributeSet attrs, Transition transition) throws XmlPullParserException, IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    String name = parser.getName();
                    if (name.equals(TypedValues.Attributes.S_TARGET)) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private TransitionManager createTransitionManagerFromXml(XmlPullParser parser, AttributeSet attrs, ViewGroup sceneRoot) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int depth = parser.getDepth();
