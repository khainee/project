...
final class Recreator implements GenericLifecycleObserver {
    ...
    private void reflectiveNew(String className) throws NoSuchMethodException, SecurityException {
        try {
            ...
            try {
                Constructor<? extends SavedStateRegistry.AutoRecreated> constructor = clsAsSubclass.getDeclaredConstructor(new Class[0]);
