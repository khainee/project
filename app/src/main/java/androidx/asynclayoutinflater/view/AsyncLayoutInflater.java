...
public final class AsyncLayoutInflater {
    ...
    @UiThread
    public void inflate(@LayoutRes int resid, @Nullable ViewGroup parent, @NonNull OnInflateFinishedListener callback) throws InterruptedException {
        if (callback == null) {
    ...
    private static class InflateThread extends Thread {
        ...
        public void enqueue(InflateRequest request) throws InterruptedException {
            try {
