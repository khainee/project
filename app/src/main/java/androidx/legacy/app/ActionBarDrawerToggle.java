...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public void setHomeAsUpIndicator(Drawable indicator) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (indicator == null) {
            this.mHomeAsUpIndicator = getThemeUpIndicator();
    ...
    public void setHomeAsUpIndicator(int resId) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public void setDrawerIndicatorEnabled(boolean enable) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    @Override // androidx.drawerlayout.widget.DrawerLayout.DrawerListener
    public void onDrawerOpened(View drawerView) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        this.mSlider.setPosition(1.0f);
        if (this.mDrawerIndicatorEnabled) {
    ...
    @Override // androidx.drawerlayout.widget.DrawerLayout.DrawerListener
    public void onDrawerClosed(View drawerView) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        this.mSlider.setPosition(0.0f);
        if (this.mDrawerIndicatorEnabled) {
    ...
    private void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (this.mActivityImpl != null) {
    ...
    private void setActionBarDescription(int contentDescRes) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (this.mActivityImpl != null) {
