...
public abstract class VersionedParcel {
    ...
    public <T> void writeSet(Set<T> val, int fieldId) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        writeCollection(val, fieldId);
    }

    public <T> void writeList(List<T> val, int fieldId) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        writeCollection(val, fieldId);
    }

    public <K, V> void writeMap(Map<K, V> val, int fieldId) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        setOutputField(fieldId);
        if (val == null) {
            writeInt(-1);
            return;
    ...
    private <T> void writeCollection(Collection<T> val, int fieldId) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        setOutputField(fieldId);
        writeCollection(val);
    }

    private <T> void writeCollection(Collection<T> collection) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (collection == null) {
            writeInt(-1);
        }
    ...
    public <T> void writeArray(T[] val, int fieldId) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        setOutputField(fieldId);
        writeArray(val);
    }
    ...
    protected <T> void writeArray(T[] tArr) throws IllegalAccessException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (tArr == 0) {
            writeInt(-1);
        }
        int n = tArr.length;
    ...
    public void writeVersionedParcelable(VersionedParcelable p, int fieldId) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        setOutputField(fieldId);
        writeVersionedParcelable(p);
    }

    protected void writeVersionedParcelable(VersionedParcelable p) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (p == null) {
            writeString(null);
            return;
        }
    ...
    public void writeSerializable(Serializable s, int fieldId) throws IOException {
        setOutputField(fieldId);
        writeSerializable(s);
    }

    private void writeSerializable(Serializable s) throws IOException {
        if (s == null) {
            writeString(null);
            return;
        }
    ...
    protected <T extends VersionedParcelable> T readFromParcel(String parcelCls, VersionedParcel versionedParcel) throws SecurityException {
        try {
    ...
    protected <T extends VersionedParcelable> void writeToParcel(T val, VersionedParcel versionedParcel) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
    ...
    private Method getReadMethod(String parcelCls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private Method getWriteMethod(Class baseCls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException {
