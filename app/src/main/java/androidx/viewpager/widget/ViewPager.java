...
public class ViewPager extends ViewGroup {
    ...
    public void setAdapter(@Nullable PagerAdapter adapter) throws Resources.NotFoundException {
    ...
    public void setPageTransformer(boolean reverseDrawingOrder, @Nullable PageTransformer transformer) throws Resources.NotFoundException {
        setPageTransformer(reverseDrawingOrder, transformer, 2);
    }

    public void setPageTransformer(boolean reverseDrawingOrder, @Nullable PageTransformer transformer, int pageLayerType) throws Resources.NotFoundException {
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        int heightSpec = View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, BasicMeasure.EXACTLY);
    ...
    */
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent event) throws Resources.NotFoundException {
