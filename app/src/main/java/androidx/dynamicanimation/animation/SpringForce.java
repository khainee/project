...
public final class SpringForce implements Force {
    ...
    DynamicAnimation.MassState updateValues(double d, double d2, long j) {
        ...
        if (this.mDampingRatio > 1.0d) {
            ...
            dPow = (d5 * Math.pow(2.718281828459045d, this.mGammaMinus * d3)) + (d6 * Math.pow(2.718281828459045d, this.mGammaPlus * d3));
            dPow2 = (d5 * this.mGammaMinus * Math.pow(2.718281828459045d, this.mGammaMinus * d3)) + (d6 * this.mGammaPlus * Math.pow(2.718281828459045d, this.mGammaPlus * d3));
        } else if (this.mDampingRatio != 1.0d) {
            double d7 = (1.0d / this.mDampedFreq) * ((this.mDampingRatio * this.mNaturalFreq * d4) + d2);
            dPow = Math.pow(2.718281828459045d, (-this.mDampingRatio) * this.mNaturalFreq * d3) * ((d4 * Math.cos(this.mDampedFreq * d3)) + (d7 * Math.sin(this.mDampedFreq * d3)));
            dPow2 = (dPow * (-this.mNaturalFreq) * this.mDampingRatio) + (Math.pow(2.718281828459045d, (-this.mDampingRatio) * this.mNaturalFreq * d3) * (((-this.mDampedFreq) * d4 * Math.sin(this.mDampedFreq * d3)) + (this.mDampedFreq * d7 * Math.cos(this.mDampedFreq * d3))));
        } else {
            double d8 = d2 + (this.mNaturalFreq * d4);
            dPow = (d4 + (d8 * d3)) * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * d3);
            dPow2 = ((d4 + (d8 * d3)) * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * d3) * (-this.mNaturalFreq)) + (d8 * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * d3));
        }
